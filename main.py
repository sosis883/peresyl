...
async def send_night_mode_message(context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "🕓Не беспокоим вас ночью, работаем с 8:00-23:00\n\n"
        "Пока админы отдыхают, вы можете ознакомиться с "
        "<a href=\"https://telegra.ph/Blokirovka-v-proekte-12-06\">нашими правилами</a> и "
        "<a href=\"https://telegra.ph/Informaciya-o-rabote-12-02\">обучением.</a>\n\n"
        "А также советуем подписаться и включить уведомления, чтобы успеть получить задания!\n\n"
        "Доброй ночи, встретимся утром!"
    )
