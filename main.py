...
async def send_night_mode_message(context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        f"🕓 Ночной перерыв — работаем с 8:00 до 23:00\n\n"
        f"Пока команда отдыхает, загляните в наше <a href=\"{URL_TRAINING}\">обучение</a> "
        f"или проверьте статус <a href=\"{URL_PAYMENTS}\">выплат</a> — всё уже там!\n\n"
        f"Подпишитесь и включите уведомления, чтобы не пропустить задания утром 🔔\n\n"
        f"Доброй ночи, до встречи в 8:00! 🌙"
    )
